...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// toolStripLabel1
			// 
			this->toolStripLabel1->DropDownItems->AddRange(gcnew cli::array< System::Windows::Forms::ToolStripItem^  >(5) {
				this->загрузитьToolStripMenuItem,
					this->открытьВидеоToolStripMenuItem, this->темыToolStripMenuItem, this->минимализмToolStripMenuItem, this->выйтиToolStripMenuItem
			});
